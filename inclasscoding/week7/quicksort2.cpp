...
void quicksort(RAIter first, RAIter last)
{
    // TODO: WRITE THIS!!!
    /*
    Rewrite quicksort to include optimizations: Median-of-3, Tail-recursion elimination, Recursive calls to sort small lists do nothing, end with insertion sort of entire list
    */
